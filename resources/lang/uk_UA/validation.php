...
return [
    ...
    'phone' => 'Поле :attribute має бути номером телефона.',
    ...
    'strip_tags' => 'Поле :attribute повинне містити тільки текст.',
    'timezone' => 'Поле :attribute повинне містити коректну часову зону.',
    'unique' => 'Таке значення поля :attribute вже існує.',
    'uploaded' => 'Завантаження поля :attribute не вдалося.',
    'url' => 'Формат поля :attribute неправильний.',
    'unique_user_phone' => 'Номер телефону вже зареєстрований',
    'user_unique_phone' => 'Номер телефону вже зареєстрований',
    'user_unique_email' => 'Такий email вже зареєстрований',

    'custom' => [
    ],

    'attributes' => [
        RegisterRequest::EMAIL_FIELD => trans('user.' . User::EMAIL_ATTRIBUTE),
        RegisterRequest::NAME_FIELD => trans('user.' . User::NAME_ATTRIBUTE),
